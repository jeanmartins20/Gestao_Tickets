...
def criar_atalho():
    ...
    # Caminho atualizado para o novo arquivo corrigido
    caminho_app = os.path.abspath("App_V3_Modernizado_corrigido.py")
    caminho_python = sys.executable
    atalho_path = os.path.join(desktop, "Gestão de Tickets V3.lnk")

    # Caminho para o ícone (ajuste se estiver em outra pasta)
